Shader "MyShader/PositionCircle" {
	Properties{
		_MainColor("Color" , Color) = (1,1,1,1) //模型颜色，后置颜色
		_HighlightColor("HighlightColor" ,Color) = (0,0,1,1) //模型高亮颜色，前置颜色
		...
		Pass{
			...
			#include "UnityCG.cginc" //引入unity的内置函数
